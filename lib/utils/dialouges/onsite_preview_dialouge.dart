                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 20),
                                              Text(onsite.customerName, style: TextStyle(fontSize: 18)),
                      Text(onsite.customerNumber, style: TextStyle(fontSize: 18)),
                      Text(
                        onsite.address,
                            ...
                            onTap: () async {
                              if (onsite.status == 'Pending') {
                                ...
                                if (onsite.amountPaid==null) {
                                  await SimpleDialouges().finalAmountDialouge(
                                    context,
                                    'Completed',
                                    onsite.id!,
                                    true
