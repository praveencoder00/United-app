...
class SalesPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final product = ref.watch(salesProvider);
    ...
    return Scaffold(
      resizeToAvoidBottomInset: true,
       ...
       appBar: AppBar(title: Text('Sales Productes'),leading: GestureDetector(
        onTap: () {
            ...
            children: [
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  onLongPress: () async => SimpleDialouges().deleteSalesDialouge(context, machine.id!) ,
                  child: Container(
